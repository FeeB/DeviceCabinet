...
- (NSDictionary *)toDictionary {
    return @{@"deviceName" : self.deviceName, @"device_id" : self.deviceId, @"category" : self.category, @"device_id" : self.deviceId, @"system_version" : self.systemVersion, @"is_booked" : self.isBookedByPerson ? @"YES" : @"NO", @"device_type" : self.deviceType};
}
