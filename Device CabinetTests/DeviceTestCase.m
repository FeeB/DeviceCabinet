...
- (void)testInitWithJson {
    ...
    NSDictionary *json = @{@"device_name" : storedDevice.deviceName, @"device_id" : storedDevice.deviceUdId, @"category" : storedDevice.category, @"system_version" : storedDevice.systemVersion, @"is_booked" : storedDevice.isBookedByPerson ? @"YES" : @"NO", @"device_type" : storedDevice.deviceType, @"image_url" : @"", @"is_booked" : @"No", @"person_id" : @""};
